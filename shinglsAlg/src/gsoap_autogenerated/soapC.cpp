...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.9 2012-08-12 18:02:32 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE_t__result:
		if (p->size < 0)
			SOAP_DELETE((t__result*)p->ptr);
		else
			SOAP_DELETE_ARRAY((t__result*)p->ptr);
		break;
	case SOAP_TYPE_ns__CompareText:
		if (p->size < 0)
...
void t__result::soap_default(struct soap *soap)
{
	...
	soap_default_xsd__int(soap, &this->t__result::cnt);
	soap_default_xsd__float(soap, &this->t__result::res1);
	soap_default_xsd__float(soap, &this->t__result::res2);
	soap_default_xsd__float(soap, &this->t__result::res3);
	this->t__result::text1.t__text::soap_default(soap);
	this->t__result::text2.t__text::soap_default(soap);
	this->t__result::text3.t__text::soap_default(soap);
}

void t__result::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
	this->t__result::text1.soap_serialize(soap);
	this->t__result::text2.soap_serialize(soap);
	this->t__result::text3.soap_serialize(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_t__result(struct soap *soap, const char *tag, int id, const t__result *a, const char *type)
{
	...
	if (soap_out_t__status(soap, "errCode", -1, &(a->t__result::errCode), ""))
		return soap->error;
	if (soap_out_xsd__int(soap, "cnt", -1, &(a->t__result::cnt), ""))
		return soap->error;
	if (soap_out_xsd__float(soap, "res1", -1, &(a->t__result::res1), ""))
		return soap->error;
	if (soap_out_xsd__float(soap, "res2", -1, &(a->t__result::res2), ""))
		return soap->error;
	if (soap_out_xsd__float(soap, "res3", -1, &(a->t__result::res3), ""))
		return soap->error;
	if ((a->t__result::text1).soap_out(soap, "text1", -1, ""))
		return soap->error;
	if ((a->t__result::text2).soap_out(soap, "text2", -1, ""))
		return soap->error;
	if ((a->t__result::text3).soap_out(soap, "text3", -1, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 t__result * SOAP_FMAC4 soap_in_t__result(struct soap *soap, const char *tag, t__result *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (t__result *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_t__result, sizeof(t__result), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE_t__result)
		{	soap_revert(soap);
			*soap->id = '\0';
	...
	size_t soap_flag_cnt1 = 1;
	size_t soap_flag_res11 = 1;
	size_t soap_flag_res21 = 1;
	size_t soap_flag_res31 = 1;
	size_t soap_flag_text11 = 1;
	size_t soap_flag_text21 = 1;
	size_t soap_flag_text31 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_cnt1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_xsd__int(soap, "cnt", &(a->t__result::cnt), "xsd:int"))
				{	soap_flag_cnt1--;
					continue;
				}
			if (soap_flag_res11 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_xsd__float(soap, "res1", &(a->t__result::res1), "xsd:float"))
				{	soap_flag_res11--;
					continue;
				}
			if (soap_flag_res21 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_xsd__float(soap, "res2", &(a->t__result::res2), "xsd:float"))
				{	soap_flag_res21--;
					continue;
				}
			if (soap_flag_res31 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_xsd__float(soap, "res3", &(a->t__result::res3), "xsd:float"))
				{	soap_flag_res31--;
					continue;
				}
			if (soap_flag_text11 && soap->error == SOAP_TAG_MISMATCH)
				if ((a->t__result::text1).soap_in(soap, "text1", "t:text"))
				{	soap_flag_text11--;
					continue;
				}
			if (soap_flag_text21 && soap->error == SOAP_TAG_MISMATCH)
				if ((a->t__result::text2).soap_in(soap, "text2", "t:text"))
				{	soap_flag_text21--;
					continue;
				}
			if (soap_flag_text31 && soap->error == SOAP_TAG_MISMATCH)
				if ((a->t__result::text3).soap_in(soap, "text3", "t:text"))
				{	soap_flag_text31--;
					continue;
				}
	...
	{	a = (t__result *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_t__result, 0, sizeof(t__result), 0, soap_copy_t__result);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_errCode1 > 0 || soap_flag_cnt1 > 0 || soap_flag_res11 > 0 || soap_flag_res21 > 0 || soap_flag_res31 > 0 || soap_flag_text11 > 0 || soap_flag_text21 > 0 || soap_flag_text31 > 0))
...
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, tag, SOAP_TYPE_t__result);
	if (this->soap_out(soap, tag?tag:"t:result", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 t__result * SOAP_FMAC2 soap_instantiate_t__result(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_t__result(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_t__result, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(t__result);
		if (size)
			*size = sizeof(t__result);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(t__result[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(t__result);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (t__result*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_t__result(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying t__result %p -> %p\n", q, p));
...
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_t__result);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 t__result ** SOAP_FMAC4 soap_in_PointerTot__result(struct soap *soap, const char *tag, t__result **a, const char *type)
{
	...
	*a = NULL;
	...
	{	t__result ** p = (t__result **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_t__result, sizeof(t__result), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
